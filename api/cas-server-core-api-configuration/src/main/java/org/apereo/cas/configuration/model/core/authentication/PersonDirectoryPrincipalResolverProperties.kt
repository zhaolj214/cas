...
open class PersonDirectoryPrincipalResolverProperties : Serializable {
     ...
     */
    var isReturnNull: Boolean = false
     ...
     */
    var isPrincipalResolutionFailureFatal: Boolean = false

    companion object {
        private const val serialVersionUID = 8929912041234879300L
    }
}

...
/**
 * This is [JdbcAuthenticationProperties].
 *
 * @author Misagh Moayyed
 * @since 5.0.0
 */
@RequiresModule(name = "cas-server-support-jdbc-authentication")
class JdbcAuthenticationProperties : Serializable {
    /**
     ...
     */
    var search: List<SearchJdbcAuthenticationProperties> = ArrayList()
    /**
     ...
     */
    var encode: List<QueryEncodeJdbcAuthenticationProperties> = ArrayList()
    /**
     ...
     */
    var query: List<QueryJdbcAuthenticationProperties> = ArrayList()
    /**
     * Settings related to bind-mode jdbc authentication.
     * Authenticates a user by attempting to create a database connection using the username and (hashed) password.
     */
    var bind: List<BindJdbcAuthenticationProperties> = ArrayList()

    companion object {
        private const val serialVersionUID = 7199786191466526110L
    }
}

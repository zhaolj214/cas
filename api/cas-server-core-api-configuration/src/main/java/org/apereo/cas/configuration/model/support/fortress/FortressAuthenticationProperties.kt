...
/**
 * This is [FortressAuthenticationProperties].
 *
 * @author Yudhi Karunia Surtan
 * @since 5.2.0
 */
@RequiresModule(name = "cas-server-support-fortress")
class FortressAuthenticationProperties : Serializable {
    /**
     ...
     */
    @RequiredProperty
    var rbaccontext = "HOME"

    companion object {

        private const val serialVersionUID = 9068259944327425315L
    }

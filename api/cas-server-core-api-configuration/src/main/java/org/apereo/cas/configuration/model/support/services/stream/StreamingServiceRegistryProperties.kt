...
/**
 * This is [StreamingServiceRegistryProperties].
 *
 * @author Misagh Moayyed
 * @since 5.2.0
 */
@RequiresModule(name = "cas-server-support-service-registry-stream")
class StreamingServiceRegistryProperties : Serializable {
     ...
     *
     */
    var replicationMode = ReplicationModes.ACTIVE_PASSIVE
    ...
    var hazelcast = StreamServicesHazelcastProperties()

    enum class ReplicationModes {
        /**
    ...
    companion object {
        ...
        private const val serialVersionUID = 4957127900906059461L
    }
}
